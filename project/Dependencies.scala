...
object Dependencies {
  val resolutionRepos = Seq(
    ...
    "Typesafe Releases" at "http://repo.typesafe.com/typesafe/releases/", // for Scala libraries
    "Typesafe repos" at "http://repo.typesafe.com/typesafe/repo/" // for Scala libraries
  )
